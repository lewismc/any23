...
public class XFNExtractorTest extends AbstractExtractorTestCase {
    ...
    private final static IRI alicesHomepage = RDFUtils.uri("http://alice.example.com/");

    private final static IRI charliesHomepage = RDFUtils.uri("http://charlie.example.com/");
