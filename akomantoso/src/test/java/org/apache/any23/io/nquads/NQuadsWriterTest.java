...
import org.apache.any23.io.akn.AkomaNtosoWriter;
...
/**
 * Test case for {@link AkomaNtosoWriter}.
 *
...
public class NQuadsWriterTest {
    ...
    private AkomaNtosoWriter writer;
    ...
    public void setUp() {
        ...
        writer = new AkomaNtosoWriter(baos);
    }
...
//        );
    ...
    public void testReadWrite() throws RDFHandlerException, IOException, RDFParseException {
        AkomaNtosoParser parser = new AkomaNtosoParser();
